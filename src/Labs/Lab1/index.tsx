export default function Lab1() {
    ...
    <div id="wd-labs1">
        ...
        <div id="wd-p-tag">
            <h4>Paragraph Tag</h4>
            <p id="wd-p-1"> This is a paragraph. We often separate a long set of sentences with vertical spaces to
                make the text easier to read. Browsers ignore vertical white spaces and render all the text as
                one single set of sentences. To force the browser to add vertical spacing, wrap the paragraphs
                you want to separate with the paragraph tag.
            </p>
            <p id="wd-p-2">
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favourite-recipe">
                <li>Cook pasta</li>
                <li>Fry onions and capsicums</li>
                <li>Add pasta sauce</li>
                <li>Mix the pasta into the sauce.</li>
                <li>Serve and enjoy!</li>
            </ol>
        ...
        <div id="wd-images">
            ...
            <br/>
            <img id="wd-teslabot" src="images/ash_pikachu.png" width={"400px"}
                 alt={"Tesla bot"}/>
        </div>
        <div id="wd-forms">
            <h4>Form Elements</h4>
